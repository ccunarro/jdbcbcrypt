 ...
 /*
  Custom modifications to check password using Bcrypt which is not supported by tomcat by default
 */

 public class JDBCBcryptRealm extends RealmBase {
     ...
     public synchronized Principal authenticate(Connection dbConnection,
         ...
         // custom modification to check credentials with bcrypt
         //boolean validated = getCredentialHandler().matches(credentials, dbCredentials);
         boolean validated = BCrypt.checkpw(credentials, dbCredentials);
